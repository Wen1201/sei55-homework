...
// add a new middleware handler for it (Rails doed this automatically)
...
app.post('/reservations', async (req, res) => {
    ...
    res.json( newReservation );  // just for now
  }catch( err ){
    console.log('Error updating flight to add reservation', err );
    res.sendStatus( 422 );
  }
