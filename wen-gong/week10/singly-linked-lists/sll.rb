...
class SLL
    ...
    def delete( value )
      ...
      while current_node && current_node.data != value && current_node.next
    ...
    def delete_at( n )
      ...
      while current_node && current_node.next && n > 0
        previous_node = current_node
        current_node = current_node.next
        n -= 1
      end
